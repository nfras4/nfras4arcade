  ...
  <div class="content">
    <header class="hero">
      <div class="title-frame">
        ...
        <h1 class="wordmark geo-title">Texas Hold'em</h1>
        <span class="diamond-accent" aria-hidden="true"></span>
      </div>
      <p class="tagline">No-limit poker / 2-8 players</p>
    </header>
    ...
    <div class="panel">
      ...
      {:else if mode === 'create'}
        <div class="panel-inner fade-in">
          ...
          <p class="panel-description">A new room will be created with a shareable 4-letter code. Each player starts with 1,000 chips.</p>
          <div class="action-row">
    ...
    <section class="rules">
      ...
      {#if showRules}
        <ol class="rules-list fade-in">
          <li><span class="step-num" aria-hidden="true">1</span><span>Each player is dealt <strong>2 hole cards</strong> face down</span></li>
          <li><span class="step-num" aria-hidden="true">2</span><span>Betting rounds occur <strong>before and after</strong> community cards are dealt</span></li>
          <li><span class="step-num" aria-hidden="true">3</span><span><strong>5 community cards</strong> are dealt: 3 (Flop), then 1 (Turn), then 1 (River)</span></li>
          <li><span class="step-num" aria-hidden="true">4</span><span>Make the <strong>best 5-card hand</strong> from your 2 cards + 5 community cards</span></li>
          <li><span class="step-num" aria-hidden="true">5</span><span>You can <strong>Fold, Check, Call, Raise, or go All In</strong> on your turn</span></li>
          <li><span class="step-num" aria-hidden="true">6</span><span>Small and Big blinds <strong>rotate each hand</strong> to keep the action going</span></li>
          <li><span class="step-num" aria-hidden="true">7</span><span>Last player with chips wins. <strong>Hand ranks:</strong> Royal Flush > Straight Flush > Four of a Kind > Full House > Flush > Straight > Three of a Kind > Two Pair > Pair > High Card</span></li>
        </ol>
      {/if}
    </section>
  </div>
