<script lang="ts">
  ...
  $effect(() => {
    if ($gameState?.code) {
      goto(`/chase-the-queen/${$gameState.code}`);
    }
  });
...
<div class="home">
  <div class="content">
    <header class="hero">
      ...
      <p class="tagline">Avoid the Queen of Spades</p>
    </header>
    ...
    <section class="rules">
      ...
      {#if showRules}
        <ol class="rules-list fade-in">
          <li><span class="step-num" aria-hidden="true">1</span><span>Cards dealt evenly to <strong>3-6 players</strong>, extras removed</span></li>
          <li><span class="step-num" aria-hidden="true">2</span><span>Trick-taking: lead any card, others <strong>must follow suit</strong> if able</span></li>
          <li><span class="step-num" aria-hidden="true">3</span><span>Highest card of the <strong>led suit</strong> wins the trick (no trumps)</span></li>
          <li><span class="step-num" aria-hidden="true">4</span><span>Winner of each trick <strong>leads the next</strong></span></li>
          <li><span class="step-num" aria-hidden="true">5</span><span>Penalty cards: <strong>Hearts</strong> (face value, J/Q/K=10, A=11) and <strong>Queen of Spades</strong> (50 pts)</span></li>
          <li><span class="step-num" aria-hidden="true">6</span><span><strong>Lowest score wins.</strong> Game ends when someone hits 500 points</span></li>
          <li><span class="step-num" aria-hidden="true">7</span><span><strong>Shoot the moon:</strong> take ALL penalty cards to double everyone else's score or halve yours</span></li>
        </ol>
      {/if}
    </section>
  </div>
