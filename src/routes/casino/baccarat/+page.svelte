<script lang="ts">
  ...
  $effect(() => {
    if ($gameState?.code) {
      goto(`/casino/baccarat/${$gameState.code}`);
    }
  });
  ...
  <div class="content">
    <header class="hero">
      <div class="title-frame">
        ...
        <h1 class="wordmark geo-title">Baccarat</h1>
        <span class="diamond-accent" aria-hidden="true"></span>
      </div>
      <p class="tagline">Bet on Player, Banker, or Tie</p>
    </header>
    ...
    <section class="rules">
      ...
      {#if showRules}
        <ol class="rules-list fade-in">
          <li><span class="step-num" aria-hidden="true">1</span><span>Bet on <strong>Player</strong>, <strong>Banker</strong>, or <strong>Tie</strong> before cards are dealt</span></li>
          <li><span class="step-num" aria-hidden="true">2</span><span>Two hands are dealt: <strong>Player hand</strong> and <strong>Banker hand</strong></span></li>
          <li><span class="step-num" aria-hidden="true">3</span><span>Card values: <strong>Ace = 1</strong>, 2-9 = face value, <strong>10/J/Q/K = 0</strong></span></li>
