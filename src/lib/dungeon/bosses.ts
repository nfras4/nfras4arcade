  ...
  'head-coach': {
    ...
    specialTimers: [
      ...
      },
      {
        ...
        description: 'Charge Down: SEB charges through you for significant damage.',
        action: () => [
  ...
  'chief-surgeon': {
    ...
    specialTimers: [
      ...
      },
      {
        ...
        description: 'Surgical Strike: BURGO delivers a precise 1.6x damage hit (defence applies).',
        action: () => [
          { type: 'log', message: "▶ When Burgo is healthy, he is genuinely terrifying. [BURGO is striking -- 1.6x damage hit incoming, defence applies]", logType: 'dmg' },
          { type: 'damage-player', multiplier: 1.6, ignoreDefence: false },
          { type: 'set-status-icon', icon: '💥', durationMs: 1000 },
        ],
      },
    ],
