<script lang="ts">
  ...
  $effect(() => {
    if ($gameState?.code) {
      goto(`/wavelength/${$gameState.code}`);
    }
  });
  ...
  <div class="content">
    <header class="hero">
      <div class="title-frame">
        ...
        <h1 class="wordmark geo-title">Wavelength</h1>
        <span class="diamond-accent" aria-hidden="true"></span>
      </div>
      <p class="tagline">Read the psychic's mind</p>
    </header>
    ...
    <section class="rules">
      ...
      {#if showRules}
        <ol class="rules-list fade-in">
          <li><span class="step-num" aria-hidden="true">1</span><span><strong>3-16 players</strong> take turns as the Psychic</span></li>
          <li><span class="step-num" aria-hidden="true">2</span><span>The Psychic sees a hidden target on a spectrum between <strong>two concepts</strong></span></li>
          <li><span class="step-num" aria-hidden="true">3</span><span>The Psychic gives <strong>clues</strong> to hint at the target's position</span></li>
          <li><span class="step-num" aria-hidden="true">4</span><span>Guessers position their <strong>needle</strong> on the dial</span></li>
          <li><span class="step-num" aria-hidden="true">5</span><span>Score points based on how close your needle is — <strong>4</strong> for bullseye, <strong>3</strong> for close, <strong>2</strong> for edge</span></li>
        </ol>
      {/if}
    </section>
  </div>
